...
review_model=pickle.load(open('review.pkl','rb'))
...
@app.route('/review_predict', methods=['GET','POST'])
def review_predict():
    ...
    pred = review_model.predict(vect)

    return render_template('reviewresult.html', prediction_text=pred)
